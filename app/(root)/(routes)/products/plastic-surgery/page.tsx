      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Plastic surgery instruments play a crucial role in achieving precise
            and transformative results. Our website offers a diverse range of
            these specialized instruments, carefully designed to meet the unique
            requirements of plastic surgery procedures.
          </p>
        </section>
