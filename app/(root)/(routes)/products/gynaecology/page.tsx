...
import gsImage from "@/assets/products_home/Gynaecology.jpg";
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Our Gynecology Instruments category encompasses a wide range of
            specialized tools tailored to the unique needs of gynecological
            procedures. From pelvic exams to intricate surgeries, each
            instrument in our collection is precision-engineered to ensure
