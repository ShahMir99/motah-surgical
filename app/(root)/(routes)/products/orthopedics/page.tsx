...
import gsImage from "@/assets/products_home/arthopedic.jpg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        ...
        >
          ...
          <h1 className="font-light text-[28px] md:text-[55px] leading-[1.35] pt-14 pb-20">
            Precision instruments for the perfect balance of
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Discover a wide array of orthopedic instruments, including bone
            saws, drills, reamers, retractors, forceps, and more. Each
            instrument is ergonomically designed for surgeon comfort and ease of
            use, reducing fatigue during lengthy procedures.
          </p>
        </section>
