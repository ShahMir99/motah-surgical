...
import lipoImage from "@/assets/products_home/Liposucction.jpeg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        ...
        >
          ...
          <h1 className="font-light text-[28px] md:text-[55px] leading-[1.35] pt-14 pb-20">
            Precision tools for sculpted body
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Liposuction is not just a procedure—it’s an art, demanding the
            utmost finesse and accuracy. That’s why our liposuction instruments
            are designed with surgical mastery in mind, ensuring every contour
            is sculpted with impeccable precision. With our tools, every
            aspiration is controlled, every curve is refined, and every
            patient’s vision of their best self is brought to life with the
            utmost safety and efficacy. When it comes to transforming the human
            form, trust in instruments that mirror the surgeon’s skill,
            embodying the perfect balance of delicacy and strength.
          </p>
        </section>
