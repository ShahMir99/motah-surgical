...
import gsImage from "@/assets/products_home/ENT-Surgery.jpeg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        ...
        >
          ...
          <h1 className="font-light text-[28px] md:text-[55px] leading-[1.35] pt-14 pb-20">
            Precision tools for perfect harmony in ENT
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Professional Hospital offers a comprehensive range of high-quality
            ENT instruments for ear, nose, and throat procedures. Our
            precision-crafted instruments are designed to ensure accurate
            diagnosis, effective treatment, and optimal patient outcomes. With a
            focus on innovation, reliability, and user comfort, our ENT
            instruments deliver exceptional performance for ENT specialists
            worldwide.
          </p>
        </section>
