...
import gsImage from "@/assets/products_home/plastic-surgery.jpg";
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Professional Arthroscopy Instruments are specifically designed for
            minimally invasive joint procedures. These instruments offer precise
            control, visibility, and access during arthroscopic surgeries. With
            a range of scopes, forceps, and other specialized tools, our
            instruments help surgeons perform procedures with greater precision,
            resulting in improved patient outcomes and faster recovery times.
          </p>
        </section>
