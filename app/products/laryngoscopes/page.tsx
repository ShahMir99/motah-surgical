...
import gsImage from "@/assets/products_home/Laryngoscopy.jpg";
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Our Laryngoscopes, comprising convemtional and fiberoptic blades and battery handles are crafted with the highest precision, using premium stainless materials that guarantee both safety and performance. Each instrument is MRI-compatible, ensuring versatility across a wide range of medical environments. Our commitment to quality means that we use the brightest lights, ensuring clear visibility during intubation procedures, while the safest design minimizes patient risk.

Our Laryngoscope blades and battery handles comply with ISO 7376 standard to guarantee that our products are always consistent and compatible and never let down the users int he most difficult situations.
          </p>
        </section>
