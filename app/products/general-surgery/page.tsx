...
// Motah Surgical brand primary — swap for `primary` if it's defined in tailwind.config
...
export default function LiposuctionCategoryPage() {
  return (
    <main className="bg-white text-[#4A5560]">
      {/* HERO */}
      <div className="grid grid-cols-1 md:grid-cols-[42%_58%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        <motion.div
        ...
        <div className="order-first md:order-last bg-[#F4F5F6] flex items-center justify-center overflow-hidden min-h-[320px]">
          <HeroIllustration />
        </div>
      </div>
