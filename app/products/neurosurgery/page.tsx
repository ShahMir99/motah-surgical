...
import gsImage from "@/assets/products_home/neurosurgery.jpg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        ...
        >
          ...
          <h1 className="font-light text-[28px] md:text-[55px] leading-[1.35] pt-14 pb-20">
            Precision in Every Incision: Empowering Neurosurgeons for
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Unlocking Precision and Potential: Professional’s neurosurgery
            instruments are meticulously designed to empower surgeons with the
            tools they need to perform intricate procedures with utmost accuracy
