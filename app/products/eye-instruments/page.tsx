...
import gsImage from "@/assets/products_home/Eye-Surgery.jpeg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] max-w-[1320px] mx-auto mt-10 min-h-[520px]">
        ...
        >
          ...
          <h1 className="font-light text-[28px] md:text-[55px] leading-[1.35] pt-14 pb-20">
           Precision tools for crystal-clear
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <section className="pt-14">
          ...
          <p className="text-ink text-[18px] leading-relaxed tracking-wide">
            Our eye instruments are engineered with a keen focus on the intricate and delicate nature of eye procedures. Each instrument in our selection is crafted from top-quality materials to guarantee durability, precision, and ease of sterilization, adhering to stringent hygiene standards.
          </p>
        </section>
